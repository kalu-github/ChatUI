 ...
 */
public final class EmojiPagerManager extends LinearLayoutManager implements RecyclerView.OnChildAttachStateChangeListener {

    private final PagerSnapHelper mPagerSnapHelper = new PagerSnapHelper();
    private int mDrift;//位移，用来判断移动方向

    public EmojiPagerManager(Context context, int orientation, boolean reverseLayout) {
